...
* UE4
  ...
  * Using IM4U
    ...
    * [Unreal Engine4でMMDモデルに表情を付ける方法](https://creator.game.cyberagent.co.jp/?p=3798)
      ...
      * Distributed MMBridge_071_Alembic requires MikuMikuDance Ver.9.26. With current MMD version MMBridge does not produce correct vmd file. 64 bit version crashes and 32 bit version produces file of size 1KB.
