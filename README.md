...
* [Validating Data With JSON-Schema](https://code.tutsplus.com/series/validating-data-with-json-schema--cms-966), [FK](http://paulfitz.github.io/dataprotocols/json-table-schema/)
