...
* Android license agreement problem of UE 4.19.2 release: run "android.bat update sdk --no-ui --filter build-tools-25.0.0,android-25,extra-android-m2repository" and move %ANDROID_HOME%android-sdk-windows\platforms\android-25 folder into %ANDROID_HOME%\platforms folder.
