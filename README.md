...
* [JSON-Schema](https://code.tutsplus.com/series/validating-data-with-json-schema--cms-966): [JSON table schema](http://paulfitz.github.io/dataprotocols/json-table-schema/)
