...
* Android license agreement problem of gradle (UE 4.19.2 release): run "android.bat update sdk --no-ui --filter build-tools-25.0.0,android-25,extra-android-m2repository" and overwrite %ANDROID_HOME% with %ANDROID_HOME%android-sdk-windows folder (%ANDROID_HOME% is "C:\NVPACK\android-sdk-windows". It's weird why android-sdk-windows has a child of same name in default installation in Windows). Run setup.bat.
